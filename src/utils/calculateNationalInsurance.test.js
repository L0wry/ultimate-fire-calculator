...
describe('Calculate National Insurance', () => {
  ...
  it("calculates medium band correctly with the default tax free amount", () => {
    const taxableIncome = 77550
    expect(calculateNationalInsurance(nationalInsuranceTaxBands, taxableIncome).mediumBand).toStrictEqual({"carryOver": 529.3561538461538, "end": 962, "start": 183.01, "taxPaid": 93.47879999999999, "taxPercent": 0.12})
  })
  ...
  it("calculates upper band correctly with without reaching the band with the default tax free amount", () => {
    const taxableIncome = 77550
    expect(calculateNationalInsurance(nationalInsuranceTaxBands, taxableIncome).upperBand).toStrictEqual({"carryOver": 0, "end": 99999999, "start": 962.01, "taxPaid": 10.587123076923076, "taxPercent": 0.02})
  })
  ...
  it("calculates upper band correctly", () => {
    ...
    expect(calculateNationalInsurance(nationalInsuranceTaxBands, taxableIncome).upperBand).toStrictEqual({"carryOver": 0, "end": 99999999, "start": 962.01, "taxPaid": 57.68327692307692, "taxPercent": 0.02})
  })
  ...
  it('Matches the snapshot', () => {
    ...
    expect(calculateNationalInsurance(nationalInsuranceTaxBands, taxableIncome)).toStrictEqual({
      ...
      "mediumBand": {"carryOver": 2884.163846153846, "end": 962, "start": 183.01, "taxPaid": 93.47879999999999, "taxPercent": 0.12}, 
      "totalNationalInsuranceTax": 48247.50399999999, 
      "upperBand": {"carryOver": 0, "end": 99999999, "start": 962.01, "taxPaid": 57.68327692307692, "taxPercent": 0.02}, 
      "weeklyNationalInsuranceTax": 927.8366153846152
    })
  })
})
